...
function(casper_add_exec target meta_prog)
	cmake_parse_arguments(FARG
		""
		""
		"SOURCES;HALIDE_GENERATORS;NODE_TYPE_IDS"
			${ARGN})
	...
	# TODO: replace this by having metaprogram generated a file with
	# a list of Halide kernel libraries that the metaprogram compiled.
	# Need two-phase CMake build to do this.
