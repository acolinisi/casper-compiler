...
int main(int argc, char **argv) {
	...
	return tryCompile(tg, "platform.ini",
		// TODO: These are for sake of mocked up. Eventually, the model
		// needs to be per kernel-platform pair. Eventually, these will
		// go away from here because they will be generated by the
		// compilation flow.
		"tf_models/model.pb",
		"tf_models/my-model.ckpt",
