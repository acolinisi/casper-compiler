...
def init_ch(state):
    ...
    # TODO: this invocation of the kernels needs to go away from here:
    # kernels returned by generators become casper tasks, and the
    # tasks are added to the graph in the metaprogram, and invoked
    # by the target binary generated by the metaprogram.
