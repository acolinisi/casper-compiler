...
# Forward from parent project (some of these need to be before project())
...
set(CMAKE_C_EXTENSIONS ${CMAKE_CXX_EXTENSIONS})
set(CMAKE_CXX_EXTENSIONS ${CMAKE_CXX_EXTENSIONS})

project(${prj} LANGUAGES ${LANGUAGES})
find_package(CASPER HINTS ${CASPER_DIR})
...
function(casper_build target app_args_file)
	...
	find_library(CASPER_RUNTIME_LIBRARY ${rtlib} REQUIRED
		PATHS ${CASPER_LIBRARIES_PATH} ${CASPER_TARGET_LIB_DIRS})
